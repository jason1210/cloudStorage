...
// Will speed up references to undefined, and allows munging its name.
    ...
    jQuery.fn = jQuery.prototype = {
        ...
        not: function( selector ) {
            ...
            // util special case where just one selector is passed in
...
// Give the init function the jQuery prototype for later instantiation
    ...
    jQuery.extend({
        ...
        // See util/unit/core.js for details concerning this function.
...
// Attach a bunch of functions for handling common AJAX events
    ...
    jQuery.extend({
        ...
        ajax: function( s ) {
            ...
            // checked again later (in the util suite, specifically)
            ...
            // Matches an absolute URL, and saves the model
            var remote = /^(?:\w+:)?\/\/([^\/?#]+)/;
